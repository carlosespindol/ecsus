...
<html lang="pt-br">
  ...
  <button class="btn btn-success ml-auto borda-quadrada" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <h6 class=" nome-usuario dropdown dropdown-toggle">BEM VINDO(A), <?php echo $_SESSION['usuario']; ?></h6>
  </button>
    ...
    <a href="logout.php" class="dropdown-item">Sair</a>
		...
		<div id="download" class="offset">
				<div class="narrow text-center">
					...
					<a href="fonte/ecsus.ttf" download><button type="button" class="btn btn-lg btn-success botao-down">Download</button></a>
				</div>
	        ...
	        <div id="comentarios" class="offset">
	          ...
	          <div class="row">
	            ...
	            <div class="col-md-6">
								<form action="coment_base.php" method="post">
	                    <div class="form-group">

													<b>Deixe seu comentário!</b>

	                        <textarea style="resize: none" required class="form-control comentae" name="coment" rows="9" cols="2"></textarea>
	                      </div>
                        <?php
                        if(isset($_GET["comentok"])):
                        ?>
                            <div>
                          ...
                          <?php
                              ...
                              unset($_SESSION["comentok"]);
                           ?>
	                        <button type="submit" class="direitavolver btn btn-success borda-quadrada">Enviar</button>
								</form>
	            </div>
 ...
 <div class="col-12 text-center">
          ...
          ?>
            ...
            <?php
                ...
                unset($_SESSION["fontecadastro"]);
             ?>

 <div class="caixa-login p-3">

 <div class="container">
 <form name="form" method="post" action="fonte.php">
 <div class="form-group">
                <input type="text" required class="form-control" id="exampleInputPassword1" name="nomefonte" placeholder="Nome da Fonte">
             </div>
						 <div class="form-group">
						 <textarea style="resize: none" required class="form-control comentae" name="desc" rows="4" cols="2" placeholder="Descrição"></textarea>
					 		</div>
             <div class="form-group">
               <input type="text" required class="form-control" id="exampleInputPassword1" name="linkfonte" placeholder="Link da Fonte">
             </div>
 ...
 <button type="submit" class="btn btn-success borda_quadrada btn-fonte">Cadastrar</button>
 </form>
 </div>
 <h4>Veja fontes recentes cadastradas por outros usuários!</h4>
										...
										<div class="row">
											<?php
		 									foreach($fontefetch as $chave => $valor){
												...
												echo	'<p class="card-text">Nome da Fonte:<b>' .$valor["nome_font"]. '</b></p>';
												echo	'Upado por:<b>' .$valor["nome"]. '</b><br>';
